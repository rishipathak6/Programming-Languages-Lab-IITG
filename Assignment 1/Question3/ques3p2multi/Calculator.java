...
public class Calculator implements KeyListener {
  ...
  private void initialize() { // render all the graphics at appropriate places and properties
    ...
    labelHeading = new JLabel("Instructions:" + calcState);
  ...
  // State 0 - no input
  // State 1 - Number 1 first digit added and start operator highlight thread
  ...
  public void keyPressed(KeyEvent e) {
    if (e.getKeyCode() == 10) { // 10 is code for enter key
      ...
      labelHeading.setText("Instructions: " + calcState);
    }
